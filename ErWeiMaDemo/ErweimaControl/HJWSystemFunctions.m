...
@implementation HJWSystemFunctions
...
+ (void)openShake:(BOOL)shaked Sound:(BOOL)sounding {
    ...
    if (sounding) {
        ...
        AudioServicesCreateSystemSoundID((__bridge CFURLRef)[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"ring.wav" ofType:nil]], &soundID);
